namespace Neighbours.Web.Areas.Administrator.Models.Communities
{
    using System;
    ...
    public class CommunityViewModel : IMapFrom<Community>, IHaveCustomMappings
    {
        ...
        public void CreateMappings(IMapperConfiguration configuration)
        {
            configuration.CreateMap<Community, CommunityViewModel>()
                   ...
                   .ForMember(c => c.Users, opts => opts.MapFrom(c => c.Users.Count))
                   .ForMember(c => c.ImageUrl, opts => opts.MapFrom(c => c.CommunityImage.UrlPath.Remove(0, 1) + "/" + c.CommunityImage.NewFileName));
        }
    }
}